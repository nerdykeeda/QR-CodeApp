...
class LinQart {
    ...
    initializeEventListeners() {
        ...
        if (storeForm) {
            ...
            inputs.forEach(input => {
                input.addEventListener('input', () => this.updateStoreInfo());
            });
        }
    ...
    saveStores() {
        ...
        // Remove existing stores for current user and add new ones
        ...
        console.log(`Saved ${this.stores.length} stores for user:`, currentUser.email);
    }
    ...
    loadStores() {
        ...
        if (saved) {
            ...
            if (currentUser) {
                ...
                console.log(`Loaded ${this.stores.length} stores for user:`, currentUser.email);
            } else {
